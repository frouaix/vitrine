...
| `TX-080` | Add invariant fuzz tests and malformed-input tests | 8 | `P0` | `M` | `TX-052`, `TX-042` | `[x]` |
| `TX-081` | Add benchmark harness and baseline scenarios | 8 | `P0` | `M` | `TX-070`, `TX-051` | `[x]` |
| `TX-082` | Define benchmark thresholds and CI reporting | 8 | `P1` | `S` | `TX-081`, `TX-003` | `[x]` |
