...
export type RgStorageMode = "fastCodeUnit" | "fastCodePoint" | "segmentedGrapheme";
...
export interface AttributedTextValueSemantic extends Omit<AttributedTextValue, "mpId_StyleEntry"> {
    mpId_StyleEntry: Record<number, SemanticStyleEntry>;
}
export interface AttributedTextValueRender extends Omit<AttributedTextValue, "mpId_StyleEntry"> {
